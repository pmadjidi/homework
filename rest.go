...
func (a *App) configureRoutes() {
	...
	a.Router.HandleFunc("/inc/step/{person}/{steps}",a.registerSteps).Methods("GET")
	...
	a.Router.HandleFunc("/add/group/{name}", a.newGroup).Methods("POST")
	a.Router.HandleFunc("/extend/group/{group}/{person}", a.extendGroup).Methods("POST")
	a.Router.HandleFunc("/get/group/{name}", a.getGroup).Methods("GET")
	a.Router.HandleFunc("/get/group/all", a.getAll).Methods("GET")
